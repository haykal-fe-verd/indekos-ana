...
function UserForm({
  ...
  return (
    <DialogContent className={cn("max-h-[calc(100vh-100px)] overflow-y-auto no-scrollbar")}>
      <DialogHeader>
        <DialogTitle>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div>
            ...
            <Select onValueChange={(e) => setData("role", e)} defaultValue={data.role}>
          ...
          <Button className="flex items-center justify-center gap-3" disabled={processing}>
