...
import { EnterIcon, EyeClosedIcon, EyeOpenIcon, UpdateIcon } from "@radix-ui/react-icons";
    ...
    <GuestLayout>
      ...
      <div className="min-h-screen flex flex-col sm:justify-center items-center">
        <Link href="/" className="flex flex-col items-center gap-3">
          <img src="/images/logo.png" alt="Logo" className="w-20 h-20 fill-current" />
            ...
            <form method="post" onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <Button type="submit" disabled={processing} className={cn("inline-flex flex-row gap-3")}>
                  {processing ? <UpdateIcon className="w-5 h-5 animate-spin" /> : <EnterIcon className="w-5 h-5" />}
                  <span>Daftar</span>
                </Button>
                <Link
                  href={route("login")}
